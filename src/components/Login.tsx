...
export function Login({ onLogin, onBack, onRegisterClick }: LoginProps) {
        ...
        <div style={{ width: '100%', maxWidth: 420 }}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 20 }}>
              ...
              <label htmlFor="remember" style={{ fontSize: 14, color: '#4b5563', cursor: 'pointer' }}>Keep me signed in</label>
            </div>
          ...
          <p style={{ textAlign: 'center', fontSize: 14, color: '#6b7280', marginTop: 24 }}>
            ...
            <a href="#" onClick={(e) => { e.preventDefault(); onRegisterClick?.(); }} style={{ color: '#2563eb', fontWeight: 600, textDecoration: 'none' }}>Create one</a>
          </p>
